...
export function Cactoro({hovered, ...props}) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('https://ksmart.myds.me/r3f/dist/models/Cactoro.gltf')
...
useGLTF.preload('https://ksmart.myds.me/r3f/dist/models/Cactoro.gltf')
