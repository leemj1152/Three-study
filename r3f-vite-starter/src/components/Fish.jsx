...
Command: npx gltfjsx@6.2.10 public/models/Fish.gltf -o src/components/Fish.jsx -r public 
*/
...
export function Fish({hovered, ...props}) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('https://ksmart.myds.me/r3f/dist/models/Fish.gltf')
...
useGLTF.preload('https://ksmart.myds.me/r3f/dist/models/Fish.gltf')
