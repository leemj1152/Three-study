...
Command: npx gltfjsx@6.2.10 public/models/Dragon_Evolved.gltf -o src/components/Dragon_Evolved.jsx -r public 
*/
...
export function Dragon_Evolved({hovered, ...props}) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('https://ksmart.myds.me/r3f/dist/models/Dragon_Evolved.gltf')
...
useGLTF.preload('https://ksmart.myds.me/r3f/dist/models/Dragon_Evolved.gltf')
